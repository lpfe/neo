...
image_num = st.sidebar.radio("생성할 이미지 개수를 성택하세요", image_num_options, index = 1, horizontal = True)
...
detail_description = st.sidebar.radio('상세묘사를 추가하는가요?', ['Yes', 'No'], index = 1, horizontal = True)
