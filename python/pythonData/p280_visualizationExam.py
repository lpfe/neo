...
dftheater = pd.read_csv(theaterfile, encoding = 'utf-8', names = colname, header = None)
...
ax1.pie(sumSeries, explode = explode, labels = mytuple, autopct = '%1.1f%%', startangle = 90, shadow = True)
